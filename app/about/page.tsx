import {
  ArrowRight, ArrowDown, Terminal, Brain, Shield, Gauge,
  GitBranch, MessageCircle, Smartphone, Layers,
  Bot, Zap, Eye, AlertTriangle, RefreshCw, FolderGit2,
  Settings, FileText, Globe, Cpu,
} from "lucide-react";
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="px-8 py-6 space-y-14 max-w-5xl">
          ...
          <div className="border-t border-[#222] pt-2">
            <div className="text-[10px] uppercase tracking-widest text-[#666]">How it works</div>
          </div>

          {/* ============================================================ */}
          {/* PART 2: HOW — Ecosystem Mechanics                            */}
          {/* ============================================================ */}
          ...
          <div>
            ...
            <div className="rounded-lg border border-[#222] p-4 font-mono text-[11px]" style={{ background: "#0d0d0d" }}>
              ...
              <div className="text-[#666] mt-0.5">
                ...
                <span className="text-[#444]"> | </span>
                <span className="text-[#06b6d4]">building feature</span>
              </div>
          ...
          <div>
            ...
            <p className="text-[11px] text-[#777] mb-4 max-w-2xl">
              ...
              for product detection, repo mapping, and board routing.
            </p>
            <div className="rounded-lg border border-[#222] overflow-hidden">
              ...
              {[
                {
                  ...
                  flow: "Telegram message > /idea evaluates (CEO+PM) > approved > GitHub issue on product board > next /start-working picks it up > agent builds, tests, ships PR > auto-merged > deployed > Telegram notification",
                  color: "#3b82f6",
                },
                {
                  title: "Overnight autonomous development",
                  flow: "/start-working in tmux > scans boards > picks P0 task > reads issue + CLAUDE.md > implements > tsc + tests pass > commits + PR > auto-merge > /post-dev > loops > quota hits 95% > auto-switches to free proxy > continues on lower-priority tasks",
                  color: "#22c55e",
                },
                {
                  title: "Weekly AI research pipeline",
                  flow: "Monday 1pm UTC cron fires > AI Researcher scans news > writes brief > creates 'Adopt' issues on Ideas board > CC Manager evaluates > creates integration issues on Company Ops > Telegram summary to Ricky",
                  color: "#8b5cf6",
                },
                {
                  title: "New product launch",
                  flow: "/idea evaluates > CEO approves > draft on Ideas board (P3) > /launch-product creates repos + board + CLAUDE.md > updates product-registry.md > seeds initial issues > agents can now work on it",
                  color: "#eab308",
                },
                {
                  title: "Quota emergency at 3am",
                  flow: "Cron checks usage-cache.json > 95% crossed > Telegram EXHAUSTED alert > auto-switch to free proxy (OpenRouter) > agent continues on lower-priority tasks > morning: Ricky sees history > /switch-model opus when quota resets",
                  color: "#ef4444",
                },
              ].map(uc => (
